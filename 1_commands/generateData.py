...
def random_dept_and_major():
    depts = ["CS","社科","工程管理","数理","人工智能","商院"]
    majors = [
        ["信息安全","计算机应用","软件工程"],
        ["社科"],
        ["金融工程","工业工程"],
    ...
    rd = random.randint(0,len(depts)-1)
    rm = random.randint(0,len(majors[rd])-1)
    
    return depts[rd],majors[rd][rm]

print("generate student data:")
students = []
for i in range(30):
    id = i
    name = random_name()
    dept,major = random_dept_and_major()
    students.append({'id':id,'name':name,'dept':dept,'major':major})
    print("({},\'{}\',\'{}\',\'{}\',{}),".format(id,name,dept,major,20))

# generate course data
print("\ngenerate course data:")
course_list = ["数据库","操作系统","数字电路","线代","微积分"]
courses = []
id = 0 
depts = ["工程管理","CS","人工智能"]
for course in course_list :
    ...
    for dept in depts:
        ...
        courses.append({'id':id,'title':title,'dept':dept,'credit':credit})
        print("({},\'{}\',\'{}\',{}),".format(id,title,dept,credit))
        id += 1
...
for s in students:
    for c in courses:
        if random.random()<0.13:
            ...
            print("({},{},{},{}),".format(s['id'],c['id'],year,grade))

# generate teacher data
print("\ngenerate teacher data")
teacher_list = ["胡伟","胡伟大","王胜利","李其芳","王曦","张帅"]
